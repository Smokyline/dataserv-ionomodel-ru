...
from site_foo import set_param, run_exe_program, draw_map, find_th_name, get_surf
...
def show_res(request):
    ...
    if param_dict['out'] == 'plot':
        # show map
        draw_map(data_type)
        return render_to_response('image_view.html', {'MEDIA_URL': settings.STATIC_URL, 'DATA_TYPE': data_type,
